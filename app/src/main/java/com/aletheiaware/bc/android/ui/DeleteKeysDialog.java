...
public abstract class DeleteKeysDialog {

    private final Activity activity;
    private AlertDialog dialog;

    public DeleteKeysDialog(Activity activity) {
    ...
    public void create() {
        ...
        ab.setPositiveButton(R.string.delete_keys_action, new DialogInterface.OnClickListener() {
            @Override
